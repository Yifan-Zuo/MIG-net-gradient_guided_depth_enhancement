...
LR_dep_art=Image.open("/media/yifan/Data/test_data/noise_free/noisefree_iccv15_test_imgs/input/"+data_name+"/4x_dep.png")
...
with tf.Session() as sess:
    model_path="/media/yifan/Data/trained_models/inten_grad_guided_depup/noise_free/4x/second_train/full_models1/4x_nf_igg_model.ckpt-18"
    ...
    result_img.save("/media/yifan/Data/trained_models/inten_grad_guided_depup/noise_free/4x/second_train/results/"+data_name+"4x_result.png")
    ######################computing rmse
