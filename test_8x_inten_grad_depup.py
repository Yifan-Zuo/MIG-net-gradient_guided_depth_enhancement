...
LR_dep_art=Image.open("/media/yifan/Data/test_data/noise_free/noisefree_iccv15_test_imgs/input/"+data_name+"/8x_dep.png")
...
inten_feat_down=igg.inten_FDown(inten_feat,2,2)
for ind in [2,1,0]:
...
with tf.Session() as sess:
    model_path="/media/yifan/Data/trained_models/inten_grad_guided_depup/noise_free/8x/second_train/full_models1/8x_nf_igg_model.ckpt-11"
    ...
    result_img.save("/media/yifan/Data/trained_models/inten_grad_guided_depup/noise_free/8x/second_train/results/"+data_name+"8x_result.png")
    ######################computing rmse
